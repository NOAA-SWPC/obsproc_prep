...
if [[ "$netwk" = "gdas" ]];then
 ...
 case $typef in
  ...
  nsfcur) geslist='
   ...
   ;;
  nstcur) geslist='
   $COMINgdas/gdas.t${cyc}z.nstf$gh.nc'
   getlist00='
   $COMINgdas/gdas.t${cyc}z.nstanl.nc'
   fhbeg=00
   ;;
  nflges) geslist='
   $COMINgdas/gdas.t${cyc}z.flxf$gh.nc'
   ;;
  nflgp3)  geslist='
   $COMINgdas/gdas.t${cyc}z.flxf$ghp3.nc'
   ;;
  nflcur) geslist='
   $COMINgdas/gdas.t${cyc}z.flxf$gh.nc'
   fhbeg=00
...
# GFS
 ...
 case $typef in
  ...
  nsfcur) geslist='
   ...
   ;;
  nstcur) geslist='
   $COMINgfs/gfs.t${cyc}z.nstf$gh.nc'
   getlist00='
   $COMINgfs/gfs.t${cyc}z.nstanl.nc'
   fhbeg=00
   ;;
  nflcur) geslist='
   $COMINgfs/gfs.t${cyc}z.flxf$gh.nc'
   fhbeg=00
   ;;
 esac
...
# Any resolution production
 ...
 case $typef in
  ...
  nsfcur) geslist='
   ...
   ;;
  nstcur) geslist='
   $GETGES_NWG/$envir/gdas.$day/gdas.t${cyc}z.nstf$gh.nc
   $COMINgdas/gdas.t${cyc}z.nstf$gh.nc
   $GETGES_NWG/$envir/gfs.$day/gfs.t${cyc}z.nstf$gh.nc
   $COMINgfs/gfs.t${cyc}z.nstf$gh.nc'
   getlist00='
   $GETGES_NWG/$envir/gdas.$day/gdas.t${cyc}z.nstanl.nc
   $COMINgdas/gdas.t${cyc}z.nstanl.nc
   $GETGES_NWG/$envir/gfs.$day/gfs.t${cyc}z.nstanl.nc
   $COMINgfs/gfs.t${cyc}z.nstanl.nc'
   fhbeg=00
   ;;
  nflges) geslist='
   $GETGES_NWG/$envir/gdas.$day/gdas.t${cyc}z.flxf$gh.nc
   $COMINgdas/gdas.t${cyc}z.flxf$gh.nc
   $GETGES_NWG/$envir/gfs.$day/gfs.t${cyc}z.flxf$gh.nc
   $COMINgfs/gfs.t${cyc}z.flxf$gh.nc'
   ;;
  nflgp3)  geslist='
   $GETGES_NWG/$envir/gdas.$day/gdas.t${cyc}z.flxf$ghp3.nc
   $COMINgdas/gdas.t${cyc}z.flxf$ghp3.nc
   $GETGES_NWG/$envir/gfs.$day/gfs.t${cyc}z.flxf$ghp3.nc
   $COMINgfs/gfs.t${cyc}z.flxf$ghp3.nc'
   ;;
  nflcur) geslist='
   $GETGES_NWG/$envir/gdas.$day/gdas.t${cyc}z.flxf$gh.nc
   $COMINgdas/gdas.t${cyc}z.flxf$gh.nc
