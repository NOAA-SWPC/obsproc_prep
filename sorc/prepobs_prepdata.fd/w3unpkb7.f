...
C$$$
     ...
     $ IDSDAT,IDSDMP_8,SUBSET,SUBSKP,IRET)
      ...
      PARAMETER   (IDMAX=1500) ! IDMAX is maximum index in RDATA
...
C              - NESDIS), =11 - ASCAT SCATTEROMETER WIND}; =12 -
...
C            (Current limit of 255 Cat. 04 levels)
C            (could be expanded if need be)

         IDATS_04 = IDATS
         RDATA(IDATS_04+3:IDATS_04+3+(244*5):5)   = 2.0
         RDATA(IDATS_04+4:IDATS_04+4+(244*5):5)   = 4.0
...
C ... ONLY FIRST (SURFACE) UPPER AIR LEVEL DATA PROCESSED
  ...
  218 FORMAT(/'##W3UNPKB7: NO UPPER-AIR DATA ABOVE FIRST (SURFACE) ',
     $ 'LEVEL PROCESSED FOR THIS REPORT -- NLEV = 0 AND NSFC > 0'/)
         ...
         END IF
C.......................................................................
      ELSE  IF(NLEV.GT.255)  THEN
C PROBLEM: THE NUMBER OF DECODED "LEVELS" IS .GT. LIMIT OF 255 --
         PRINT 2186, NLEV
 2186    FORMAT(/'##W3UNPKB7: NUMBER OF UPPER-AIR LEVELS FOR THIS ',
     $    'REPORT (=',I3,') EXCEEDS LIMIT OF 255 CAT. 04 LEVELS -- ',
     $    'ONLY FIRST 255 LEVELS WILL BE PROCESSED'/)
         NLEV = 255
C.......................................................................
      END IF
      DO I = 1,NLEV
...
C       HORIZONTAL WIND SPEED     (STORED AS REAL) (VAD FROM RADAR CODED
C        MESSAGE)
